 ...
 */
ria_client_t *
ria_export_device(const char *address, const char *device)
{
	ifd_device_t	*dev;
	ria_client_t	*ria;
	ct_socket_t	*sock;
...
int
ria_register_device(ria_client_t *ria, const char *name)
{
...
int
ria_devsock_process(ct_socket_t *sock, header_t *hdr,
...
void
ria_devsock_close(ct_socket_t *sock)
{
...
static int
ria_poll_device(ct_socket_t *sock, struct pollfd *pfd)
{
...
void
ria_close_device(ct_socket_t *sock)
{
